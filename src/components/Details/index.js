    ...
    <>
      <section id='details' class='details'>
        <div class='container'>
          ...
          <div class='row content'>
            <div
              class='col-md-4 order-1 order-md-2 aos-init aos-animate'
              data-aos='fade-left'
            >
              <img src='/img/details-4.png' class='img-fluid' alt='' />
            </div>
            <div
              class='col-md-8 pt-5 order-2 order-md-1 aos-init aos-animate'
              data-aos='fade-up'
            >
              <h3>
              ...
              <ul>
                <li>
                  <i class='bi bi-check'></i> Et praesentium laboriosam
                  architecto nam .
                </li>
                <li>
                  <i class='bi bi-check'></i> Eius et voluptate. Enim earum
